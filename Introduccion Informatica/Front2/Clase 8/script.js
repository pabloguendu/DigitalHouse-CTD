...
const sectionNacional=document.querySelector(".nacional");
const sectioninternacional=document.querySelector(".internacional");
function agregarElemento(array){
    array.forEach(element => {
        if(element.tipoNacional){
